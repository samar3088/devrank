...
**Built ✅ (10/11):** #1 Judge0 code execution · #2 verifiable rank credentials · #3 bias-reduced hiring · #4 smart matching · #5 AI mock-interview · #6 GitHub import · #7 in-app notifications · #8 seasons/leagues/weekly challenges · #9 skill paths · #10 response SLAs.
**Pending:**
- **#11 Verified hire outcomes + salary transparency — ❌** (the last roadmap item): two-sided hire confirmation + real-offer salary data.
